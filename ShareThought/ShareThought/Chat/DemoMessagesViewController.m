...
- (void)viewDidLoad
{
    ...
    */
    ...
    self.senderDisplayName = kJSQDemoAvatarDisplayNameSelf;
...
- (void)receiveMessagePressed:(UIBarButtonItem *)sender
{
    ...
    if (!copyMessage) {
        copyMessage = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdTim
                                          displayName:kJSQDemoAvatarDisplayNameTim
                                                 text:@"First received!"];
    }
