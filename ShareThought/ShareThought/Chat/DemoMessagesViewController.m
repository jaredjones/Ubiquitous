...
- (void)viewDidLoad
{
    ...
    //UIButton *lButton = [[[self inputToolbar] contentView] leftBarButtonItem];
    JSQMessagesComposerTextView *inputText = [[[self inputToolbar] contentView] textView];
    
    [rButton setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];
    [rButton setTitleColor:[UIColor colorWithRed:220.0/255.0f green:82.0/255.0f blue:62.0/255.0f alpha:1.0f] forState:UIControlStateHighlighted];
    //[lButton removeFromSuperview];
    
    [inputText setBackgroundColor:[UIColor colorWithRed:0.22 green:0.22 blue:0.22 alpha:1.0]];
    [inputText setTextColor:[UIColor whiteColor]];
    [inputText setPlaceHolder:@"Type a message..."];
    inputText.keyboardAppearance = UIKeyboardAppearanceDark;
    
    [[self inputToolbar] setBarStyle:UIBarStyleBlackTranslucent];
    ...
    self.senderId = [_demoData idSelf];
    self.senderDisplayName = [_demoData displayNameSelf];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.senderDisplayName = [[User me] username];
    
    [_demoData setDisplayNameOther:[_user username]];
    [_demoData setDisplayNameSelf:[[User me] username]];
